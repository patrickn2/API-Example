...
func Test_Clerks(t *testing.T) {
	...
	tcases := map[string]struct {
		...
		"Limit 6. Next Page": {
			...
			params:          &interfaces.GetClerksParams{Limit: func(u uint) *uint { return &u }(6)},
			expectedError:   nil,
			expectedOutput: &ClerksResponse{
				Users:      []*schema.User{{Id: 123}, {Id: 234}, {Id: 345}, {Id: 456}, {Id: 567}, {Id: 678}},
				TotalUsers: 6,
		...
		"Limit 6. Ending Before no Previous Page": {
			getClerksOutput: []*schema.User{{Id: 123}, {Id: 234}, {Id: 345}, {Id: 456}, {Id: 567}, {Id: 678}},
			params:          &interfaces.GetClerksParams{Limit: func(u uint) *uint { return &u }(6), EndingBefore: func(u uint) *uint { return &u }(789)},
			expectedError:   nil,
			expectedOutput: &ClerksResponse{
				Users:      []*schema.User{{Id: 123}, {Id: 234}, {Id: 345}, {Id: 456}, {Id: 567}, {Id: 678}},
				TotalUsers: 6,
		...
		"Limit 6. Ending Before, Previous Page": {
			getClerksOutput: []*schema.User{{Id: 123}, {Id: 234}, {Id: 345}, {Id: 456}, {Id: 567}, {Id: 678}, {Id: 789}},
			params:          &interfaces.GetClerksParams{Limit: func(u uint) *uint { return &u }(6), EndingBefore: func(u uint) *uint { return &u }(890)},
			expectedError:   nil,
			expectedOutput: &ClerksResponse{
	...
	for name, tcase := range tcases {
		t.Run(name, func(t *testing.T) {
			repo.EXPECT().GetClerks(tcase.params).Return(tcase.getClerksOutput, tcase.expectedError)
			userService := NewUserService(repo)
			users, err := userService.Clerks(tcase.params)
